		...
		for rarity in rarities:
			for group in Group:
				...
				for atlas_plane in range(0, num_atlas_planes):
					...
					atlas_normal_path = os.path.join(self.output_directory, f'img/thumbnails/{atlas_identifier}_normal.webp').replace('\\', '/')
					...
					atlas_idolized_path = os.path.join(self.output_directory, f'img/thumbnails/{atlas_identifier}_idolized.webp').replace('\\', '/')
